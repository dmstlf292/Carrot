...
import useSWR from 'swr';//swr hook! redux action 대신에 사용하는것도 괜찮다
...
const Profile = () => {
  ...
  //return 이 hooks보단 위에 있을순 없다, 날 먼저 찾아야한다
  if (!me) {
    return '내 정보 로딩중...';
  }
  //return 이 hooks보단 위에 있을순 없
